...
:greeting
echo %greetingMsg%
echo Checking if variable defied.
echo 1st method with using internal DEFINED keyword
if DEFINED a (
    set a
 ) else (
    echo Variable a not defined
 )
 echo 2nd method with using simple comparasion ^"^%a^%^" == ""
if "%a%" == "" (
    echo Variable a not defined
 ) else (
    set a
