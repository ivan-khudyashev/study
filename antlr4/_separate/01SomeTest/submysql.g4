...
/* query_specification: SELECT id_ ',' '(' SELECT '*' FROM id_ ')' AS id_ FROM id_ WHERE id_ '>' decimal_literal LIMIT decimal_literal;*/
query_specification:
   SELECT select_list from_clause 
   | SELECT select_list_star from_clause 
   | SELECT select_list from_clause limit_clause 
    ;
...
//---------
//---------
// TODO: define only keywords which define mysql server
...
// TODO: make datetime string literal
